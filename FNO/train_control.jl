...
x_train, y_train, x_valid, y_valid = read_velocity_cigs_offsets_as_nc_old(dataset_path, modelConfig, ntrain=ntrain, nvalid=nvalid)
...
DFNO_3D.train!(trainConfig, model, θ, plotEval=plot_cig_eval_wrapper(use_nz, labels=labels))
